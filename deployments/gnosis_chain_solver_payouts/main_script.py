...
from gnosis_chain_solver_payouts.gnosis_scan_api import get_block_range
from gnosis_chain_solver_payouts.execute_sql_queries import (
    get_auction_range,
...
def main(year: int, month: int, day: int, ignore_gnosis_transfers = False) -> str:
    ...
    message += "solver, performance, quoting, consistency, total\n"
    for solver in final_rewards_per_solver:
